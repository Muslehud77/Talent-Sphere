...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <nav
        className="md:absolute lg:h-20 bg-black lg:bg-transparent top-0 z-50 flex w-full flex-wrap items-center justify-between py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 lg:py-4"
        data-te-navbar-ref
      >
        <motion.div
          animate={{ y: 0 }}
